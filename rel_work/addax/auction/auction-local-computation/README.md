...
./auction-non-interactive -a 100 -b 10000 -s ~/addax/auction/tools/build/100-10000-s1-idx -S ~/addax/auction/tools/build/100-10000-s2-idx -d ~/addax/auction/tools/build/shares_10000 -p 6666

./auction-non-interactive -k -a 100 -b 10000 -s ~/addax/auction/tools/build/100-10000-s1-idx -S ~/addax/auction/tools/build/100-10000-s2-idx -d ~/addax/auction/tools/build/shares_10000 -i 127.0.0.1 -p 6666
### How to build
```
cmake . -B build
cd build
